...
export const normalContainerStyle: React.CSSProperties = {
  display: 'flex',
  position: 'absolute',
...
export const normalTitleStyle: React.CSSProperties = {
...
export const selectedTitleStyle: React.CSSProperties = {
  ...normalTitleStyle,
