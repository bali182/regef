...
import { ComponentsState, ComponentType } from '../types'

const insert = (array, index, items) => [...array.slice(0, index), ...items, ...array.slice(index)]
    ...
    case ADD_CONNECTION: {
      ...
      return {
        ...
        [source]: {
          ...node,
          connections:
            connections.indexOf(target) >= 0 ? connections : connections.concat([target]),
        },
      }
    }
